...
module.exports = function pages() {
    return function () {
        ...
        return new Promise(function (resolve) { resolve(); })
            ...
            .then(function() { return git(["add", "."], { cwd: "./pages/" }); })
            .then(function() { return git(["commit", "-m", "Deploy to GitHub Pages"], { cwd: "./pages/" }); })
            .then(function() { return git(["push", "--force", "--quiet"], { cwd: "./pages/" }); });
    };
};