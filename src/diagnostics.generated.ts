...
export const Diagnostics = {
    ...
    Unicode_character_name_literal_that_includes_a_code_point_must_have_a_description: { code: 1016, message: "Unicode character name literal that includes a code point must have a description" } as Diagnostic,
    Unicode_character_name_literal_code_point_and_description_must_be_separated_by_whitespace: { code: 1017, message: "Unicode character name literal code point and description must be separated by whitespace" } as Diagnostic,
    Unicode_character_name_literal_may_not_start_with_U_unless_it_is_a_valid_code_point: { code: 1018, message: "Unicode character name literal may not start with 'U+' unless it is a valid code point" } as Diagnostic,
